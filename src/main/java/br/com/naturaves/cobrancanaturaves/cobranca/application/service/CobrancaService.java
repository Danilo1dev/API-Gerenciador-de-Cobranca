...
import br.com.naturaves.cobrancanaturaves.cobranca.application.api.CobrancaTituloListResponse;
...
public interface CobrancaService {
	...
	List<CobrancaTituloListResponse> buscaCobrancaDoCliente(UUID idCliente);
